...
let groups_data = [
    { id: 1, name: 'グループ A', detail: '東京都渋谷区', subscribe: false, subscribe_from: [2, 3] },
    { id: 2, name: 'グループ B', detail: '東京都新宿区', subscribe: false, subscribe_from: [1] },
    { id: 3, name: 'グループ C', detail: '東京都港区', subscribe: false, subscribe_from: [1] },
];
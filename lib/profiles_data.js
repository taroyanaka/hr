...
let groups_data = [
    { id: 1, name: 'グループ A', address: '東京都渋谷区', subscribe: false, subscribe_from: [2, 3] },
    { id: 2, name: 'グループ B', address: '東京都新宿区', subscribe: false, subscribe_from: [1] },
    { id: 3, name: 'グループ C', address: '東京都港区', subscribe: false, subscribe_from: [1] },
];